...
SharedPreferences sharedPreferences;
    ...
    String [] SouresURl =
            {       "https://newsapi.org/v1/articles?source=reuters&sortBy=top&apiKey=beddc17c318f45a79f3bbb0cb83cce26",
                    "https://newsapi.org/v1/articles?source=time&sortBy=top&apiKey=beddc17c318f45a79f3bbb0cb83cce26",
                    "https://newsapi.org/v1/articles?source=daily-mail&sortBy=top&apiKey=beddc17c318f45a79f3bbb0cb83cce26",
                    "https://newsapi.org/v1/articles?source=the-guardian-uk&sortBy=top&apiKey=beddc17c318f45a79f3bbb0cb83cce26",
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        num=sharedPreferences.getInt("Source_URL",0);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v1 = inflater.inflate(R.layout.fragment_top, container, false);
        ...
        rv=(RecyclerView)v1.findViewById(R.id.Rec_1stFrag);
        getData();
...
//////////// Volley Json Getter
    public void getData(){
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, SouresURl[num] , null,
...
///////// universal lib for images  Instantiation
    public void showimg() {
